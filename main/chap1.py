...
class Chap1Window(QWidget):
    ...
    def __init__(self):
        ...
        self.creditbutton.setText("menu")
        self.creditbutton.setGeometry(900,10,50,50)
        self.creditbutton.clicked.connect(self.menuopen)
    ...
    def menuopen(self):
        if not self.menu_open:
            from menucode.menu import Menu_window
            self.menu_open = Menu_window()
            self.menu_open.switch_window.connect(self.show_main_menu)
        self.menu_open.show()
        self.close()
    ...
    def trust1open(self):
        if not self.trust_open:
            from problemcode.trust import TrustWindow
    ...
    def trust2open(self):
        if not self.trust_open:
            from problemcode.trust2 import TrustWindow
    ...
    def trust3open(self):
        if not self.trust_open:
            from problemcode.trust3 import TrustWindow
    ...
    def trust4open(self):
        if not self.trust_open:
            from problemcode.trust4 import TrustWindow
...
class Musicadd(QWidget):
    ...
    def download_and_add(self):
        ...
        txt_file_path = r"../main/musicinfo.txt"
...
class Music_credit(QWidget):
    def __init__(self):
        ...
        try:
           with open("../main/musicinfo.txt", "r", encoding="utf-8") as file:
...
class BugreportWindow(QWidget):
    def __init__(self):
        ...
        try:
            with open(r"../main/bug.txt", "r", encoding="utf-8") as file:
                credit_content = file.read()
        except FileNotFoundError:
            credit_content = "File not found."
        except Exception as e:
            credit_content = f"Error reading file: {e}"
