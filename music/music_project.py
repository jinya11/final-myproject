...
class Music(QWidget):
    ...
    def __init__(self):
        ...
        pixmap = QPixmap(r"../music/music.png")
        ...
        self.music_directory = r"../main/musicdir"
        self.music_list = os.listdir(self.music_directory)  # 노래 목록 가져오기

        self.correct_answer_path = r"../main/musicinfo.txt"
    ...
    def check_answer(self):
        ...
        with open(self.correct_answer_path, 'r', encoding='utf-8') as file:
            ...
            correct_answers = [re.findall(r'\b([^\(\)\[\]\{\}\s-]+)\b', line) for line in lines]
